...
export default {
  ...
  ULTIMATUM_CHALLENGE: '도전: ',
  ULTIMATUM_CHALLENGE_EXTERMINATE: '몬스터 웨이브 완료하기',
  ULTIMATUM_CHALLENGE_SURVIVAL: '살아남기',
  ULTIMATUM_CHALLENGE_DEFENSE: '제단 지키기',
  ULTIMATUM_CHALLENGE_CONQUER: '두름돌 안에 서기',
  ULTIMATUM_REWARD: '보상: ',
  ULTIMATUM_REWARD_DOUBLE_CURRENCY: '소모되는 화폐 2배',
  ULTIMATUM_REWARD_DOUBLE_DIVCARDS: '소모되는 점술 카드 2배',
  ULTIMATUM_REWARD_MIRROR_RARE: '아이템과 복제본',
  ULTIMATUM_SACRIFICE: '필요한 대가: ',
  ULTIMATUM_SACRIFICE_STACK: /^(?<name>.+) x\d+개$/,
  // ---
  CHAT_SYSTEM: /^: (?<body>.+)$/,
