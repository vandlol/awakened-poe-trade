...
export default {
  ...
  ULTIMATUM_CHALLENGE: 'Испытание: ',
  ULTIMATUM_CHALLENGE_EXTERMINATE: 'Победите волны монстров',
  ULTIMATUM_CHALLENGE_SURVIVAL: 'Выживите',
  ULTIMATUM_CHALLENGE_DEFENSE: 'Защитите Алтарь',
  ULTIMATUM_CHALLENGE_CONQUER: 'Стойте на каменных кругах',
  ULTIMATUM_REWARD: 'Награда: ',
  ULTIMATUM_REWARD_DOUBLE_CURRENCY: 'Удваивает принесённую в жертву валюту',
  ULTIMATUM_REWARD_DOUBLE_DIVCARDS: 'Удваивает принесённые в жертву гадальные карты',
  ULTIMATUM_REWARD_MIRROR_RARE: 'Предмет и его зеркальная копия',
  ULTIMATUM_SACRIFICE: 'Требуется жертвоприношение: ',
  ULTIMATUM_SACRIFICE_STACK: /^(?<name>.+) x\d+$/,
  // ---
  CHAT_SYSTEM: /^: (?<body>.+)$/,
